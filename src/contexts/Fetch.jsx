...
const FetchContextProvider = (props) => {
    ...
    const FetchData = async() => {
        ...
        uPlanItems.sort(function(a,b){return a.index - b.index})
        postItems.sort(function(a,b){return a.index - b.index})
        skillsItems.sort(function(a,b){return a.index - b.index}) 
...
useEffect(() => {
    FetchData();
      ...
      return (
          <FetchContext.Provider value={{ skillsData, imgData, load, error, postData, uPlanData }}>
              {props.children}
